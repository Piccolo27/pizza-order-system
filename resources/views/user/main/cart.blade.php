                ...
                <table class="table table-light table-borderless table-hover text-center mb-0" id="dataTable"
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class=" align-middle"><img src="{{ asset('storage/'.$c->pizza_image) }}" class=" img-thumbnail shadow-sm" alt="" style="width: 70px;"></td>
                            ...
                            <td class="align-middle col-3" id="total">{{ $c->pizza_price * $c->quantity }} kyats</td>
